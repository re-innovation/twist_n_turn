...
#define COLOUR_TRIGGER_LEVEL        600     // This is the change from baseline to trigger colour test

#define WHITE_SETPOINT              200     // This sets the brightness of the LEDs when 'waiting' in white

#define RED_WEIGHT                  400     // The lower this number the more sensitive it is to the colour
#define GREEN_WEIGHT                350
